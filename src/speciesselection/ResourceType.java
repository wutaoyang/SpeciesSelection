 ...
 * different than that in the paper. That is, in the paper an indicator set referrs to a set of species
...
public class ResourceType implements Comparable<ResourceType> {
    ...
    public ResourceType(){
        specList=new ArrayList<Species>(); 
    }
     ...
     * 
     * @param otherRT A second resource type to be compared
     * @return True iff the current resource type is redundant w.r.t otherRT, 
    ...
    public String toString(){
         ...
         specStr.append(id).append(":"+numSpecies());
